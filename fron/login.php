                  ...
                  <form role="form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
                    ...
                    <div class="form-group">
                      <div class="input-group input-group-alternative">
                        ...
                        <input class="form-control" placeholder="Password" type="password" name="clave">
                      </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary mt-4">Iniciar Seccion</button>
                              </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="text-center">
                                <a href="register.php">
                                    <button type="button" class="btn btn-primary mt-4">Registrarse</button>
                                </a>
